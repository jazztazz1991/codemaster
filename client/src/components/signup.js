            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 cGradient">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <p className="mt-8 text-center text-sm text-gray-500">
                        Already Registered? <Link href="" className="flex w-full justify-center rounded-md bg-gray-800 px-3 py-1.5 text-sm font-semibold leading-6 text-gray-300 shadow-sm hover:text-white hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign In</Link>
                    </p>

                    {error && (
                        <div className="mt-4 text-center mx-auto max-w-xl bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
